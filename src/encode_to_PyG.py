...
parser.add_argument('--parse-timestamps', action="store_true", default=False)
parser.add_argument('--get-active-hour', action="store_true", default=False)
parser.add_argument('--get-timestamps-features', action="store_true", default=False)
parser.add_argument('--timestamps-in-seconds', action="store_true", default=False)
...
parser.add_argument('--get-total-active-time', action="store_true", default=False)
parser.add_argument('--get-time-series', action="store_true", default=False)
